...
#define REG_RCU_TOFFS_R020			32	// Сдвиг срабатывания синхронизации RCU при 2.00 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R050			33	// Сдвиг срабатывания синхронизации RCU при 5.00 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R100			34	// Сдвиг срабатывания синхронизации RCU при 10.0 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R150			35	// Сдвиг срабатывания синхронизации RCU при 15.0 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R200			36	// Сдвиг срабатывания синхронизации RCU при 20.0 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R300			37	// Сдвиг срабатывания синхронизации RCU при 30.0 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R500			38	// Сдвиг срабатывания синхронизации RCU при 50.0 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R600			39	// Сдвиг срабатывания синхронизации RCU при 60.0 А/мкс (в нс x10)
#define REG_RCU_TOFFS_R1000			40	// Сдвиг срабатывания синхронизации RCU при 100  А/мкс (в нс x10)
//
// ----------------------------------------
//
