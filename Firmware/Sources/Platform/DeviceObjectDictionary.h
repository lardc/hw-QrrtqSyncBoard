...
//
#define REG_RES_QRR_mQ				209	// Reverse recovery charge (in mC) (Calculation defined by GOST)
#define REG_RES_QRR_uQ				210	// Reverse recovery charge (in uC) (Calculation defined by GOST)
