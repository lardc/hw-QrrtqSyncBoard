...
#define REG_FALL_RATE_R3			53 	// Фактическая скорость спада при 3 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R4			54 	// Фактическая скорость спада при 4 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R5			55 	// Фактическая скорость спада при 5 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R6			56 	// Фактическая скорость спада при 6 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R7			57 	// Фактическая скорость спада при 7 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R8			58 	// Фактическая скорость спада при 8 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R9			59 	// Фактическая скорость спада при 9 скорости спада комплекса (в А/мкс x10)
#define REG_FALL_RATE_R10			60 	// Фактическая скорость спада при 10 скорости спада комплекса (в А/мкс x10)
//
#define REG_I_TO_V_OFFSET_R0		61  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R0				62	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R0			63	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R1		64  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R1				65	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R1			66	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R2		67  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R2				68	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R2			69	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R3		70  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R3				71	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R3			72	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R4		73  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R4				74	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R4			75	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R5		76  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R5				77	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R5			78	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R6		79  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R6				80	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R6			81	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R7		82  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R7				83	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R7			84	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R8		85  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R8				86	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R8			87	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R9		88  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R9				89	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R9			90	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R10		91 // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R10			92	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R10			93	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
//
#define REG_CTRL1_OFFSET_R0			94	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R0				95	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R1			96	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R1				97	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R2			98	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R2				99	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R3			100	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R3				101	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R4			102	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R4				103	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R5			104	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R5				105	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R6			106	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R6				107	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R7			108	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R7				109	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R8			110	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R8				111	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R9			112	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R9				113	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_CTRL1_OFFSET_R10		114	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K_R10				115	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
//
#define REG_CTRL2_OFFSET			116	// Добавочное смещение грубой подстройки амплитуды прямого тока
#define REG_CTRL2_K					117	// Добавочный коэффициент грубой подстройки амплитуды прямого тока
//
#define REG_I_TO_DAC_P0				118	// Добавочное смещение компенсации амплитуды прямого тока
...
//
// DCU/RCU COMMANDS, REGISTER, STATES
//
#define REG_DRCU_I_TO_V_INTPS_EXT_OFFSET	132 // Добавочное смещение преобразования тока в напряжение внутреннего источника
#define REG_DRCU_I_TO_V_INTPS_EXT_K			133	// Добавочный коэффицент преобразования тока в напряжение внутреннего источника
#define REG_DRCU_I_TO_V_INTPS_EXT_K2		134	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника
#define REG_DRCU_CTRL_EXT_OFFSET			135	// Добавочное смещение грубой подстройки амплитуды прямого тока
#define REG_DRCU_CTRL_EXT_K					136	// Добавочный коэффицент грубой подстройки амплитуды прямого тока
#define REG_DRCU_I_TO_DAC_EXT_P0			137	// Добавочное смещение компенсации амплитуды прямого тока
#define REG_DRCU_I_TO_DAC_EXT_P1			138	// Добавочный коэффициент компенсации амплитуды прямого тока
#define REG_DRCU_I_TO_DAC_EXT_P2			139	// Добавочный квадратичный коэффициент компенсации амплитуды прямого тока
//
