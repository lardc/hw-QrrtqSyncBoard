...
#define REG_I_TO_V_INTPS_EXT_K		133	// Добавочный коэффицент преобразования тока в напряжение внутреннего источника
#define REG_I_TO_V_INTPS_EXT_K2		134	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника
#define REG_CTRL_EXT_OFFSET			135	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL_EXT_K				136	// Добавочный коэффицент грубой подстройки амплитуды обратного тока
//
...
#define REG_SCOPE_RESULT_TS		    210 // Time ts
#define REG_SCOPE_RESULT_TF		    211 // Time tf
//
