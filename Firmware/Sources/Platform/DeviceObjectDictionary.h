...
//
#define REG_I_TO_V_OFFSET			70  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K				71	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2				72	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_CTRL2_OFFSET			73	// Добавочное смещение грубой подстройки амплитуды прямого тока
#define REG_CTRL2_K					74	// Добавочный коэффициент грубой подстройки амплитуды прямого тока
#define REG_CTRL1_OFFSET			75	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K					76	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_I_TO_DAC_P0				77	// Добавочное смещение компенсации амплитуды прямого тока
#define REG_I_TO_DAC_P1				78	// Добавочный коэффициент компенсации амплитуды прямого тока
#define REG_I_TO_DAC_P2				79	// Добавочный квадратичный коэффициент компенсации амплитуды прямого тока
//
