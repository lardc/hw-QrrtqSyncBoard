...
//
#define REG_I_TO_V_OFFSET_R0		70  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R0				71	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R0			72	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R1		73  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R1				74	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R1			75	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R2		76  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R2				77	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R2			78	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R3		79  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R3				80	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R3			81	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R4		82  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R4				83	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R4			84	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R5		85  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R5				86	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R5			87	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R6		88  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R6				89	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R6			90	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R7		91  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R7				92	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R7			93	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R8		94  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R8				95	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R8			96	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R9		97  // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R9				98	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R9			99	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
#define REG_I_TO_V_OFFSET_R10		100 // Добавочное смещение преобразования тока в напряжение внутреннего источника (P0 для скорости спада)
#define REG_I_TO_V_K_R10			101	// Добавочный коэффициент преобразования тока в напряжение внутреннего источника (P1 для скорости спада)
#define REG_I_TO_V_K2_R10			102	// Добавочный квадратичный коэффициент преобразования тока в напряжение внутреннего источника (P2 для скорости спада)
//
#define REG_CTRL2_OFFSET			103	// Добавочное смещение грубой подстройки амплитуды прямого тока
#define REG_CTRL2_K					104	// Добавочный коэффициент грубой подстройки амплитуды прямого тока
#define REG_CTRL1_OFFSET			105	// Добавочное смещение грубой подстройки амплитуды обратного тока
#define REG_CTRL1_K					106	// Добавочный коэффициент грубой подстройки амплитуды обратного тока
#define REG_I_TO_DAC_P0				107	// Добавочное смещение компенсации амплитуды прямого тока
#define REG_I_TO_DAC_P1				108	// Добавочный коэффициент компенсации амплитуды прямого тока
#define REG_I_TO_DAC_P2				109	// Добавочный квадратичный коэффициент компенсации амплитуды прямого тока
//
#define REG_IRR_MIN					110	// Минимальное измеряемое значение Irr в А
// ----------------------------------------
//
